...
export default function BookingScreen() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if ('fallback' in result) { setMessage('WhatsApp fallback'); await Linking.openURL(result.whatsappUrl); return; }
...
const styles = StyleSheet.create({
  ...
  estimateCard: { position: 'relative', flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#EEFFD9', borderRadius: radius.lg, padding: 15, paddingRight: 34, borderWidth: 1, borderColor: '#D0F08F' }, estimateKicker: { color: '#557B31', fontSize: 9, fontWeight: '900', letterSpacing: .8 }, estimateText: { color: '#5D7651', fontSize: 10, lineHeight: 15, marginTop: 4, maxWidth: 220 }, estimateValue: { marginLeft: 'auto', alignItems: 'flex-end' }, estimatePrice: { color: colors.ink, fontSize: 19, fontWeight: '900' }, estimateDuration: { color: '#687C62', fontSize: 9, fontWeight: '800', marginTop: 2 }, removeEstimate: { position: 'absolute', right: -25, top: -22, color: '#78906E', fontSize: 19, fontWeight: '900' },
  ...
  photoButton: { flexDirection: 'row', alignItems: 'center', gap: 11, borderRadius: radius.lg, padding: 15, borderWidth: 1, borderStyle: 'dashed', borderColor: '#9FB3A9', backgroundColor: '#F0F4EF' }, photoIcon: { width: 39, height: 39, borderRadius: 12, backgroundColor: '#E2EAE2', alignItems: 'center', justifyContent: 'center' }, photoIconText: { color: colors.ink, fontSize: 20, fontWeight: '900' }, photoTitle: { color: colors.ink, fontSize: 14, fontWeight: '900' }, photoText: { color: colors.muted, fontSize: 11, marginTop: 3 },
  message: { color: colors.danger, fontSize: 12, lineHeight: 18 }, primary: { minHeight: 58, borderRadius: 16, backgroundColor: colors.lime, paddingHorizontal: 17, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, primaryText: { color: colors.ink, fontSize: 14, fontWeight: '900' }, primaryArrow: { color: colors.ink, fontSize: 22, fontWeight: '900' },
