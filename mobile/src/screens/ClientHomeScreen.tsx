...
export default function ClientHomeScreen() {
  ...
  return <ScrollView style={styles.screen} contentContainerStyle={styles.wrap} contentInsetAdjustmentBehavior="never">
...
const styles = StyleSheet.create({
  ...
  wrap: { paddingBottom: 32, backgroundColor: colors.paper },
  hero: { position: 'relative', overflow: 'hidden', backgroundColor: colors.ink, borderBottomLeftRadius: 34, borderBottomRightRadius: 34, paddingHorizontal: 23, paddingBottom: 23, minHeight: 292, justifyContent: 'flex-end' },
  ...
  title: { color: '#fff', fontSize: 35, lineHeight: 38, fontWeight: '900', letterSpacing: -1.4, marginTop: 8 },
