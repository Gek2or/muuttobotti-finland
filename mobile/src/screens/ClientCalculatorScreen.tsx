...
const styles = StyleSheet.create({
  ...
  hero: { position: 'relative', overflow: 'hidden', backgroundColor: '#06191F', borderRadius: radius.xl, padding: 20, minHeight: 170, justifyContent: 'flex-end', borderWidth: 1, borderColor: '#214650' }, heroGlow: { position: 'absolute', width: 190, height: 190, borderRadius: 95, backgroundColor: '#315E66', opacity: .55, right: -80, top: -85 }, kicker: { color: colors.lime, fontSize: 9, fontWeight: '950', letterSpacing: 1.1 }, title: { color: '#fff', fontSize: 29, lineHeight: 32, fontWeight: '950', letterSpacing: -1, marginTop: 6 }, copy: { color: '#ADC0BC', fontSize: 13, lineHeight: 20, marginTop: 7, maxWidth: '90%' },
  ...
  panel: { backgroundColor: '#fff', borderRadius: radius.lg, padding: 15, borderWidth: 1, borderColor: colors.line, ...shadow }, label: { color: '#6C7F7A', fontSize: 9, fontWeight: '950', letterSpacing: .85, textTransform: 'uppercase', marginBottom: 9 }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, chip: { minHeight: 43, borderRadius: 12, paddingHorizontal: 12, borderWidth: 1, borderColor: '#DDE5DE', backgroundColor: '#F0F4F0', alignItems: 'center', justifyContent: 'center' }, chipActive: { backgroundColor: colors.ink, borderColor: colors.ink }, chipText: { color: '#5E716C', fontSize: 11, fontWeight: '900' }, chipTextActive: { color: colors.lime },
  stepper: { flexDirection: 'row', gap: 6, backgroundColor: '#EDF2ED', borderRadius: 15, padding: 5 }, stepButton: { width: 52, height: 54, borderRadius: 12, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' }, stepText: { color: colors.ink, fontSize: 23, fontWeight: '900' }, valueBox: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 }, value: { color: colors.ink, fontSize: 22, fontWeight: '950' }, unit: { color: colors.muted, fontSize: 11, fontWeight: '850' },
  ...
  result: { position: 'relative', overflow: 'hidden', backgroundColor: '#06191F', borderRadius: radius.xl, padding: 20, borderWidth: 1, borderColor: '#214650' }, resultGlow: { position: 'absolute', width: 170, height: 170, borderRadius: 85, backgroundColor: colors.lime, opacity: .11, right: -75, bottom: -90 }, resultLabel: { color: colors.lime, fontSize: 9, fontWeight: '950', letterSpacing: 1 }, price: { color: '#fff', fontSize: 43, fontWeight: '950', letterSpacing: -1.8, marginTop: 4 }, duration: { color: '#AFC3BE', fontSize: 13, fontWeight: '800' }, note: { color: '#8EA7A1', fontSize: 11, lineHeight: 17, marginTop: 10, maxWidth: '85%' },
  primary: { minHeight: 58, borderRadius: 16, backgroundColor: colors.lime, paddingHorizontal: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', ...shadow }, primaryText: { color: colors.ink, fontSize: 14, fontWeight: '950' }, arrow: { color: colors.ink, fontSize: 22, fontWeight: '950' },
});
